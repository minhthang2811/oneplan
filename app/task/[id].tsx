...
import { tagLabel } from '../../src/data/seed';
import { formatDuration, formatClock, slotLabel } from '../../src/lib/time';
        ...
        <View style={{ alignItems: 'center', gap: space.base, paddingTop: space.sm }}>
          ...
          <Rise delay={200}>
            <View style={{ flexDirection: 'row', flexWrap: 'wrap', justifyContent: 'center', gap: space.sm }}>
              ...
              <Meta icon="sun.max" label={slotLabel(task.slot)} />
              {task.tag ? <Meta icon="tag" label={tagLabel(task.tag)} /> : null}
            </View>
          </Rise>
        </View>
