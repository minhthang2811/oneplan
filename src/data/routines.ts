...
export const ROUTINES: Record<Exclude<Slot, 'anytime'>, RoutineOption[]> = {
  morning: [
    ...
    { id: 'incense', emoji: '🪔', minutes: 2 },
    { id: 'plants', emoji: '🪴', minutes: 5 },
  ...
  evening: [
    ...
    { id: 'laundry', emoji: '🫧', minutes: 15 },
    { id: 'hang-clothes', emoji: '👚', minutes: 10 },
    { id: 'teeth-pm', emoji: '🪥', minutes: 3 },
    { id: 'skincare', emoji: '🧴', minutes: 5 },
    { id: 'meds-pm', emoji: '💊', minutes: 2 },
    { id: 'movie', emoji: '🎬', minutes: 20 },
